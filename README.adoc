...
As we have a running instance of Apache APISIX, we can create a Route.

=== How it works

We learned above that Apache APISIX offers a couple of abstractions: upstreams and routes.
