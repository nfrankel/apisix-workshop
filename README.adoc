...
If you want to use something else, please do it but the instructor probably won't be able to help you if there's an issue.
...
We learned above about abstractions that Apache APISIX offers.
In this section, we will create the most basic one, the `Route`.
When Apache APISIX receives a request matching the `Route`, it forwards it to the embedded upstream.
...
[source,bash]
----
include::./commands/1_create_route.sh[]
----
====
...
[source,bash]
----
include::./commands/2_created_route_test.sh[]
----
====
...
[source,bash]
----
include::./commands/3_create_upstream.sh[]
----
====
...
[source,bash]
----
include::./commands/4_bind_route_to_upstream.sh[]
----
====
...
[source,bash]
----
include::./commands/5_bind_route_to_upstream_test.sh[]
----
====
...
[source,bash]
----
include::./commands/6_authentication_enable_failed_test.sh[]
----
====
...
[source,bash]
----
include::./commands/7_authentication_enable_success_test.sh[]
----
====
...
[source,bash]
----
include::./commands/8_update_consumer_jwt_credentials.sh[]
----
====
...
[source,bash]
----
include::./commands/8_add_jwt_plugin_to_route.sh[]
----
====
...
[source,bash]
----
include::./commands/8_jwt_plugin_enable_public-api-plugin.sh[]
----
====
...
[source,bash]
----
include::./commands/8_jwt_plugin_generate_token.sh[]
----
====
...
[source,bash]
----
include::./commands/8_jwt_plugin_in_use.sh[]
----
====
...
[source,bash]
----
include::./commands/8_jwt_plugin_failure_example.sh[]
----
====
...
[source,bash]
----
include::./commands/9_http_logger_plugin_enable.sh[]
----
====
...
[source,bash]
----
include::./commands/14_custom_file_logger_plugin_enable.sh[]
----
====
