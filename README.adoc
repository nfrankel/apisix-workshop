...
image::grafana-dashboard-apisix.webp[]

The APISIX dashboard should show up:

image::grafana-dashboard-for-apisix.png[]
...
In this section, we will discover some more advanced use-cases of Apache APISIX.
